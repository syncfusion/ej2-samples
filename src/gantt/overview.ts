import { Gantt, Selection, Toolbar, DayMarkers, Edit, Filter, Reorder, Resize, ColumnMenu, VirtualScroll, Sort, RowDD, ContextMenu, ExcelExport, PdfExport, CriticalPath } from '@syncfusion/ej2-gantt';
            ...
            type: 'Input', align: 'Right', template: new DropDownList({
                ...
                change: function (args: any) {
                    if (args.value == 'Grid') {
                        ...
                        gantt.setSplitterPosition('55%', 'position');
                    }
                }
            })
