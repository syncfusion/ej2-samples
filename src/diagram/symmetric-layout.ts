...
function setNodeTemplate(obj: NodeModel): void {
    ...
    if (!((obj.data as EmployeeInfo).Type) || (obj.data as EmployeeInfo).Type === 'Server') {
        obj.width = 30;
        obj.height = 30;
        obj.shape = {
            type: 'Native', content: '<svg width="50" height="65"><g id="Server2_shape" fill="transparent" stroke="transparent" ' +
                ' stroke-width="1" opacity="1" stroke-dasharray="" transform="translate(-15.517241379310343,-2.6329421835819375),' +
