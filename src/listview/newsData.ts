...
export let newsData: any = [
    ...
    },
    {
        ...
        + 'to add to your reading list:</p><p>5. Hadoop Succinctly<sup>®</sup></p><p>An Apache open source project'
        ...
        + 'Cassandra Succinctly<sup>®</sup></p><p>Apache Cassandra is an open-source distributed database system'
        ...
        + 'Succinctly<sup>®</sup></p><p>Mastering big data requires an aptitude at every step of information'
        + 'processing. Post-processing, one of the most important steps, is where you find Apache'
        + 'Spark frequently employed. Spark Succinctly<sup>®</sup>, by Marko Švaljek, addresses Spark’s use in the'
        ...
        + 'Succinctly<sup>®</sup></p><p>Neural networks are an exciting field of software development used to'
        ...
        + 'Data Capture and Extraction with C# Succinctly<sup>®</sup></p><p>Capturing and extracting information'
        ...
        + 'productivity. In Data Capture and Extraction with C# Succinctly<sup>®</sup>, author Ed Freitas guides'
