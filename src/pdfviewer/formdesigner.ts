 ...
 (window as any).default = (): void => {
    ...
    viewer.documentLoad = function (args) {
        if(args.documentName === 'FormDesigner.pdf')
        {
            ...
            viewer.formDesignerModule.addFormField("RadioButton", {bounds: { X: 148, Y: 289, Width:18, Height:18}, name: "Radio", isSelected: false } as RadioButtonFieldSettings);
            viewer.formDesignerModule.addFormField("RadioButton", {bounds: { X: 292, Y: 289, Width:18, Height:18}, name: "Radio", isSelected: false } as RadioButtonFieldSettings);
