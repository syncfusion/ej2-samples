...
export let bubbleFluentColors: string[] = ["rgba(97, 69, 112, 0.5)", "rgba(76, 111, 177, 0.5)", "rgba(204, 105, 82, 0.5)", "rgba(63, 87, 154, 0.5)", "rgba(78, 160, 155, 0.5)", "rgba(110, 122, 137, 0.5)", "rgba(212, 81, 92, 0.5)",
...
export let bubbleFluentDarkColors: string[] = ["rgba(138, 177, 19, 0.5)", "rgba(42, 114, 213, 0.5)", "rgba(67, 183, 134, 0.5)", "rgba(88, 78, 198, 0.5)", "rgba(232, 95, 156, 0.5)", "rgba(110, 122, 137, 0.5)", "rgba(234, 98, 102, 0.5)",
...
export let bubbleBootstrap5Colors: string[] = ["rgba(38, 46, 11, 0.5)", "rgba(102, 142, 31, 0.5)", "rgba(175, 110, 16, 0.5)", "rgba(134, 44, 11, 0.5)", "rgba(31, 45, 80, 0.5)", "rgba(100, 104, 11, 0.5)", "rgba(49, 21, 8, 0.5)",
    "rgba(76, 76, 129, 0.5)", "rgba(12, 125, 160, 0.5)", "rgba(134, 44, 11, 0.5)"];
export let bubbleBootstrap5DarkColors: string[] = ["rgba(94, 203, 155, 0.5)", "rgba(168, 96, 241, 0.5)", "rgba(235, 168, 68, 0.5)", "rgba(85, 126, 247, 0.5)", "rgba(233, 89, 155, 0.5)", "rgba(191, 197, 41, 0.5)", "rgba(59, 198, 207, 0.5)",
