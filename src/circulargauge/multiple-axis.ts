...
this.default = (): void => {
    ...
    document.getElementById('axisIndex').onchange = () => {
        axisIndex = parseInt((<HTMLInputElement>document.getElementById('axisIndex')).value, 10);
        (<HTMLInputElement>document.getElementById('axisDirection')).value = circulargauge.axes[axisIndex].direction;
    ...
    document.getElementById('axisDirection').onchange = () => {
        circulargauge.axes[axisIndex].direction = <GaugeDirection>(<HTMLInputElement>document.getElementById('axisDirection')).value;
